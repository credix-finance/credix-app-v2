...
describe("Credix Client", () => {
    ...
    it("fetches different markets based on their name", () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const marketAData = Object.assign(Object.assign({}, Market_fixture_1.globalMarketFixture), { lpTokenMintAccount: marketALPTokenMintAccount.publicKey });
        const marketBData = Object.assign(Object.assign({}, Market_fixture_1.globalMarketFixture), { lpTokenMintAccount: marketBLPTokenMintAccount.publicKey });
