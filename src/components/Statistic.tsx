...
export const Statistic = ({ label, value, currency, isPercentage = false }: StatisticProps) => {
	...
	return (
		<div className="bg-transparent border border-solid border-darker rounded-[1px] font-sans h-36 max-w-lg min-w-[16rem] w-full md:min-w-[12rem] ml-[21.5px] pr-5 flex items-center">
