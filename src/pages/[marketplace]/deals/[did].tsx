			...
			<div className="bg-neutral-0 p-12 space-y-7">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-5">
					<div className="p-6 border border-solid border-neutral-60">
						<div>Pricipal</div>
						<div className="text-2xl font-bold pt-2">{numberFormatter.format(deal?.principal.toNumber())} USDC</div>
					</div>
					<div className="p-6 border border-solid border-neutral-60">
						<div>Financing Fee</div>
						<div className="text-2xl font-bold pt-2">{deal?.financingFeePercentage && formatRatio(deal?.financingFeePercentage)?.toNumber()}%</div>
					</div>
					<div className="p-6 border border-solid border-neutral-60">
					...
					<div className="p-3 border border-solid border-neutral-60">
						...
						<div className="flex justify-between items-center pt-2">
							...
							<div className="font-bold">
								{principalRepaidRatio}%
							</div>
						</div>
					</div>
					<div className="p-3 border border-solid border-neutral-60 relative">
						<div className={`absolute top-0 left-0 h-1 bg-neutral-60 w-[${interestRepaidRatio}%]`}></div>
					...
					<div className="p-3 border border-solid border-neutral-60 relative">
						<div className={`absolute top-0 left-0 h-1 bg-neutral-60 w-[${daysRemainingRatio}%]`}></div>
						<div>Time Left</div>
